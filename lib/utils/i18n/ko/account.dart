const Map<String, String> enAccount = {
  ...
  'wc.data': 'Data',
  'guide.title.0': 'Dark Theme',
  'guide.title.1': 'Message Module',
  'guide.title.2': 'DOT Staking',
  'guide.title.3': 'Polkawallet Browser',
  'guide.text.0': 'Make your eyes comfortable at night',
  'guide.text.1': 'Know everything anywhere, anytime',
  'guide.text.2': 'Bridging your assets from different chains',
  'guide.text.3': 'Explore the ecosystem through the browser',
  'guide.next': 'Next',
