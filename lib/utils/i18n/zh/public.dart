const Map<String, String> zhPublic = {
  ...
  'event.0415.5': '当前 22.44% LKSM Staking APY (以 KSM 计算)',
  'event.0415.6': '质押 LKSM 获取受益吧!',
  'event.0415.7': '为你的 KSM Staking 赚取额外 10% APY',
  'event.0415.8': '跨链转帐',
  ...
  'event.0515.5': '当前 14.78% LDOT Staking APY (以 DOT 计算)',
  'event.0515.6': '质押 LDOT 获取受益吧!',
  'event.0515.7': '为你的 DOT Staking 赚取额外 10% APY',
  'event.0515.8': '跨链转帐',
  ...
  'hub.chain.select.from': '转出链',
  'hub.chain.select.to': '转入链',
